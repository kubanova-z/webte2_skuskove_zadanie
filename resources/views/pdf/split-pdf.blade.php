...
@section('content')
    <div class="max-w-2xl mx-auto mt-8 bg-white p-6 shadow rounded">
        <h2 class="text-xl font-bold mb-4">Rozdeliť PDF</h2>
        ...
        <form method="POST" action="{{ route('pdf.split-pdf.process') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Rozdeliť po:</label>
                <input type="number" name="split_size" value="1" min="1" class="mt-1 block w-full">
                <p class="text-sm text-gray-500">Po koľkých stranách sa má rozdeliť (1 = každá strana zvlášť)</p>
            </div>
