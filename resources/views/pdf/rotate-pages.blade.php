...
@section('content')
    <div class="max-w-2xl mx-auto mt-8 bg-white p-6 shadow rounded">
        <h2 class="text-xl font-bold mb-4">Otočiť strany PDF</h2>
        ...
        <form method="POST" action="{{ route('pdf.rotate-pages.process') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Strany na otočenie (napr. 1,3,5):</label>
                <input type="text" name="pages" required class="mt-1 block w-full">
            </div>

            <div class="mb-4">
                <label class="block font-medium text-gray-700">Uhol otočenia:</label>
