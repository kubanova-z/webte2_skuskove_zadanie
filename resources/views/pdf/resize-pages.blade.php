...
@section('content')
    <div class="max-w-2xl mx-auto mt-8 bg-white p-6 shadow rounded">
        <h2 class="text-xl font-bold mb-4">{{ __('messages.resize_pages_title') }}</h2>
        ...
        <form method="POST" action="{{ route('pdf.resize-pages.process') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block font-medium text-gray-700">{{ __('messages.resize_size') }}:</label>
